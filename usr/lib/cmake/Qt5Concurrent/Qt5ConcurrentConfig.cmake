...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Concurrent" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Concurrent_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5Concurrent_VERSION_STRING 5.2.1)
...
if (NOT TARGET Qt5::Concurrent)
    ...
    set(_Qt5Concurrent_OWN_INCLUDE_DIRS "${_qt5Concurrent_install_prefix}/include/qt5/" "${_qt5Concurrent_install_prefix}/include/qt5/QtConcurrent")
    ...
    foreach(_module_dep ${_Qt5Concurrent_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.2.1 ${_Qt5Concurrent_FIND_VERSION_EXACT}
    ...
    _populate_Concurrent_target_properties(RELEASE "libQt5Concurrent.so.5.2.1" "" )
