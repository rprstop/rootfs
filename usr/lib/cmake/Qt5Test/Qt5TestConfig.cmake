...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Test" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Test_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5Test_VERSION_STRING 5.2.1)
...
if (NOT TARGET Qt5::Test)
    ...
    set(_Qt5Test_OWN_INCLUDE_DIRS "${_qt5Test_install_prefix}/include/qt5/" "${_qt5Test_install_prefix}/include/qt5/QtTest")
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/qt5/QtTest/5.2.1"
        "${_qt5Test_install_prefix}/include/qt5/QtTest/5.2.1/QtTest"
    )
    ...
    foreach(_module_dep ${_Qt5Test_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.2.1 ${_Qt5Test_FIND_VERSION_EXACT}
    ...
    _populate_Test_target_properties(RELEASE "libQt5Test.so.5.2.1" "" )
