...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Widgets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Widgets_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5Widgets_VERSION_STRING 5.2.1)
...
if (NOT TARGET Qt5::Widgets)
    ...
    set(_Qt5Widgets_OWN_INCLUDE_DIRS "${_qt5Widgets_install_prefix}/include/qt5/" "${_qt5Widgets_install_prefix}/include/qt5/QtWidgets")
    set(Qt5Widgets_PRIVATE_INCLUDE_DIRS
        "${_qt5Widgets_install_prefix}/include/qt5/QtWidgets/5.2.1"
        "${_qt5Widgets_install_prefix}/include/qt5/QtWidgets/5.2.1/QtWidgets"
    )
    ...
    _populate_Widgets_target_properties(RELEASE "libQt5Widgets.so.5.2.1" "" )
    ...
    macro(_populate_Widgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Widgets_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Widgets_check_file_exists(${imported_location})
