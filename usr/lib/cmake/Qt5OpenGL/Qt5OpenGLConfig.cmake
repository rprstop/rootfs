...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5OpenGL" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5OpenGL_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5OpenGL_VERSION_STRING 5.2.1)
...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(_Qt5OpenGL_OWN_INCLUDE_DIRS "${_qt5OpenGL_install_prefix}/include/qt5/" "${_qt5OpenGL_install_prefix}/include/qt5/QtOpenGL")
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/qt5/QtOpenGL/5.2.1"
        "${_qt5OpenGL_install_prefix}/include/qt5/QtOpenGL/5.2.1/QtOpenGL"
    )
    ...
    foreach(_module_dep ${_Qt5OpenGL_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.2.1 ${_Qt5OpenGL_FIND_VERSION_EXACT}
    ...
    _populate_OpenGL_target_properties(RELEASE "libQt5OpenGL.so.5.2.1" "" )
