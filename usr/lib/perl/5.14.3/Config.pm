...
tie %Config, 'Config', {
    ...
    eunicefix => ':',
    exe_ext => '',
    full_ar => 'cortexa9hf-vfp-neon-poky-linux-gnueabi/arm-poky-linux-gnueabi-ar',
    inc_version_list => ' ',
    installman1dir => '',
    installman3dir => '',
    ...
    intsize => '4',
    ld => 'arm-poky-linux-gnueabi-gcc  -march=armv7-a -mthumb-interwork -mfloat-abi=hard -mfpu=neon -mtune=cortex-a9 ',
